...
struct RelationFollowListResponse {
    1: required i32 status_code, // 0:成功 other:失败
    2: optional string status_msg,
    3: optional list<common.User> follow_list,
}
...
struct RelationFollowerListResponse {
    1: required i32 status_code, // 0:成功 other:失败
    2: optional string status_msg,
    3: optional list<common.User> follower_list,
}
...
struct RelationFriendListResponse {
    1: required i32 status_code, // 0:成功 other:失败
    2: optional string status_msg,
    3: optional list<FriendUser> friend_list,
}

service RelationService {
    RelationActionResponse RelationAction(1: RelationActionRequest request) (api.post = "/douyin/relation/action/"),
    RelationFollowListResponse RelationFollowList(1: RelationFollowListRequest request) (api.get = "/douyin/relation/follow/"),
    RelationFollowerListResponse RelationFollowerList(1: RelationFollowerListRequest request) (api.get = "/douyin/relation/follower/"),
    RelationFriendListResponse RelationFriendList(1: RelationFriendListRequest request) (api.get = "/douyin/relation/friend/"),
}