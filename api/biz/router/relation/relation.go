...
import (
	...
	relation "simple-douyin/api/biz/handler/relation"
)
	...
	root := r.Group("/", rootMw()...)
	{
		_douyin := root.Group("/douyin", _douyinMw()...)
		{
			...
			}
			{
				...
				_follow.GET("/", append(_relationfollowlistMw(), relation.RelationFollowList)...)
			}
			{
				_follower := _relation.Group("/follower", _followerMw()...)
				_follower.GET("/", append(_relationfollowerlistMw(), relation.RelationFollowerList)...)
			}
			{
				_friend := _relation.Group("/friend", _friendMw()...)
				_friend.GET("/", append(_relationfriendlistMw(), relation.RelationFriendList)...)
			}
		}
	}
}
