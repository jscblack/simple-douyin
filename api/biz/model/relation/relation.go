...
type RelationFollowListResponse struct {
	...
	StatusCode int32          `thrift:"status_code,1,required" form:"status_code,required" json:"status_code,required" query:"status_code,required"`
	StatusMsg  *string        `thrift:"status_msg,2,optional" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"`
	FollowList []*common.User `thrift:"follow_list,3,optional" form:"follow_list" json:"follow_list,omitempty" query:"follow_list"`
}
...
type RelationFollowerListResponse struct {
	...
	StatusCode   int32          `thrift:"status_code,1,required" form:"status_code,required" json:"status_code,required" query:"status_code,required"`
	StatusMsg    *string        `thrift:"status_msg,2,optional" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"`
	FollowerList []*common.User `thrift:"follower_list,3,optional" form:"follower_list" json:"follower_list,omitempty" query:"follower_list"`
}
...
type FriendUser struct {
	...
	MsgType int64 `thrift:"msg_type,13,required" form:"msg_type,required" json:"msg_type,required" query:"msg_type,required"`
}
...
type RelationFriendListResponse struct {
	...
	StatusCode int32         `thrift:"status_code,1,required" form:"status_code,required" json:"status_code,required" query:"status_code,required"`
	StatusMsg  *string       `thrift:"status_msg,2,optional" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"`
	FriendList []*FriendUser `thrift:"friend_list,3,optional" form:"friend_list" json:"friend_list,omitempty" query:"friend_list"`
}
