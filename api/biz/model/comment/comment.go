...
type CommentActionResponse struct {
	...
	Comment *common.Comment `thrift:"comment,3,optional" form:"comment" json:"comment,omitempty" query:"comment"`
}
...
var CommentActionResponse_Comment_DEFAULT *common.Comment

func (p *CommentActionResponse) GetComment() (v *common.Comment) {
	if !p.IsSetComment() {
...
type CommentListResponse struct {
	...
	StatusMsg *string `thrift:"status_msg,2,optional" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"`
	// 评论列表
	CommentList []*common.Comment `thrift:"comment_list,3,optional" form:"comment_list" json:"comment_list,omitempty" query:"comment_list"`
}
