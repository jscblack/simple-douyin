...
type UpdateUserCounterRequest struct {
	UserId    int64  `thrift:"user_id,1,required" frugal:"1,required,i64" json:"user_id"`
	Counter   string `thrift:"counter,2,required" frugal:"2,required,string" json:"counter"`
	Increment bool   `thrift:"increment,3,required" frugal:"3,required,bool" json:"increment"`
}

func NewUpdateUserCounterRequest() *UpdateUserCounterRequest {
	return &UpdateUserCounterRequest{}
}

func (p *UpdateUserCounterRequest) InitDefault() {
	*p = UpdateUserCounterRequest{}
}

func (p *UpdateUserCounterRequest) GetUserId() (v int64) {
	return p.UserId
}

func (p *UpdateUserCounterRequest) GetCounter() (v string) {
	return p.Counter
}

func (p *UpdateUserCounterRequest) GetIncrement() (v bool) {
	return p.Increment
}
func (p *UpdateUserCounterRequest) SetUserId(val int64) {
	p.UserId = val
}
func (p *UpdateUserCounterRequest) SetCounter(val string) {
	p.Counter = val
}
func (p *UpdateUserCounterRequest) SetIncrement(val bool) {
	p.Increment = val
}

var fieldIDToName_UpdateUserCounterRequest = map[int16]string{
	1: "user_id",
	2: "counter",
	3: "increment",
}

func (p *UpdateUserCounterRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UpdateUserCounterRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_UpdateUserCounterRequest[fieldId]))
}

func (p *UpdateUserCounterRequest) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.UserId = v
...
func (p *UpdateUserCounterRequest) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Counter = v
...
func (p *UpdateUserCounterRequest) ReadField3(iprot thrift.TProtocol) error {
...
func (p *UpdateUserCounterRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UpdateUserCounterRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *UpdateUserCounterRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("user_id", thrift.I64, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI64(p.UserId); err != nil {
...
func (p *UpdateUserCounterRequest) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("counter", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Counter); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *UpdateUserCounterRequest) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("increment", thrift.BOOL, 3); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteBool(p.Increment); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *UpdateUserCounterRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UpdateUserCounterRequest(%+v)", *p)
}

func (p *UpdateUserCounterRequest) DeepEqual(ano *UpdateUserCounterRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	...
	if !p.Field2DeepEqual(ano.Counter) {
		return false
	}
	if !p.Field3DeepEqual(ano.Increment) {
		return false
	}
	return true
}

func (p *UpdateUserCounterRequest) Field1DeepEqual(src int64) bool {
...
func (p *UpdateUserCounterRequest) Field2DeepEqual(src string) bool {

	if strings.Compare(p.Counter, src) != 0 {
		return false
	}
	return true
}
func (p *UpdateUserCounterRequest) Field3DeepEqual(src bool) bool {
...
type UpdateUserCounterResponse struct {
	StatusCode int32   `thrift:"status_code,1,required" frugal:"1,required,i32" json:"status_code"`
	StatusMsg  *string `thrift:"status_msg,2,optional" frugal:"2,optional,string" json:"status_msg,omitempty"`
}

func NewUpdateUserCounterResponse() *UpdateUserCounterResponse {
	return &UpdateUserCounterResponse{}
}

func (p *UpdateUserCounterResponse) InitDefault() {
	*p = UpdateUserCounterResponse{}
}

func (p *UpdateUserCounterResponse) GetStatusCode() (v int32) {
	return p.StatusCode
}

var UpdateUserCounterResponse_StatusMsg_DEFAULT string

func (p *UpdateUserCounterResponse) GetStatusMsg() (v string) {
	if !p.IsSetStatusMsg() {
		return UpdateUserCounterResponse_StatusMsg_DEFAULT
	}
	return *p.StatusMsg
}
func (p *UpdateUserCounterResponse) SetStatusCode(val int32) {
	p.StatusCode = val
}
func (p *UpdateUserCounterResponse) SetStatusMsg(val *string) {
	p.StatusMsg = val
}

var fieldIDToName_UpdateUserCounterResponse = map[int16]string{
	1: "status_code",
	2: "status_msg",
}

func (p *UpdateUserCounterResponse) IsSetStatusMsg() bool {
	return p.StatusMsg != nil
}

func (p *UpdateUserCounterResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UpdateUserCounterResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_UpdateUserCounterResponse[fieldId]))
}

func (p *UpdateUserCounterResponse) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(); err != nil {
		return err
	} else {
		p.StatusCode = v
...
func (p *UpdateUserCounterResponse) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.StatusMsg = &v
...
func (p *UpdateUserCounterResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UpdateUserCounterResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *UpdateUserCounterResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("status_code", thrift.I32, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.StatusCode); err != nil {
...
func (p *UpdateUserCounterResponse) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetStatusMsg() {
		if err = oprot.WriteFieldBegin("status_msg", thrift.STRING, 2); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *UpdateUserCounterResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UpdateUserCounterResponse(%+v)", *p)
}

func (p *UpdateUserCounterResponse) DeepEqual(ano *UpdateUserCounterResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *UpdateUserCounterResponse) Field1DeepEqual(src int32) bool {
...
func (p *UpdateUserCounterResponse) Field2DeepEqual(src *string) bool {
...
type UserService interface {
	...
	UpdateUserCounter(ctx context.Context, req *UpdateUserCounterRequest) (r *UpdateUserCounterResponse, err error)
}
...
func (p *UserServiceClient) UpdateUserCounter(ctx context.Context, req *UpdateUserCounterRequest) (r *UpdateUserCounterResponse, err error) {
	var _args UserServiceUpdateUserCounterArgs
	_args.Req = req
	var _result UserServiceUpdateUserCounterResult
	if err = p.Client_().Call(ctx, "UpdateUserCounter", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewUserServiceProcessor(handler UserService) *UserServiceProcessor {
	...
	self.AddToProcessorMap("UpdateUserCounter", &userServiceProcessorUpdateUserCounter{handler: handler})
	return self
}
...
type userServiceProcessorUpdateUserCounter struct {
	handler UserService
}

func (p *userServiceProcessorUpdateUserCounter) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := UserServiceUpdateUserCounterArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("UpdateUserCounter", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := UserServiceUpdateUserCounterResult{}
	var retval *UpdateUserCounterResponse
	if retval, err2 = p.handler.UpdateUserCounter(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing UpdateUserCounter: "+err2.Error())
		oprot.WriteMessageBegin("UpdateUserCounter", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("UpdateUserCounter", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type UserServiceUpdateUserCounterArgs struct {
	Req *UpdateUserCounterRequest `thrift:"req,1" frugal:"1,default,UpdateUserCounterRequest" json:"req"`
}

func NewUserServiceUpdateUserCounterArgs() *UserServiceUpdateUserCounterArgs {
	return &UserServiceUpdateUserCounterArgs{}
}

func (p *UserServiceUpdateUserCounterArgs) InitDefault() {
	*p = UserServiceUpdateUserCounterArgs{}
}

var UserServiceUpdateUserCounterArgs_Req_DEFAULT *UpdateUserCounterRequest

func (p *UserServiceUpdateUserCounterArgs) GetReq() (v *UpdateUserCounterRequest) {
	if !p.IsSetReq() {
		return UserServiceUpdateUserCounterArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *UserServiceUpdateUserCounterArgs) SetReq(val *UpdateUserCounterRequest) {
	p.Req = val
}

var fieldIDToName_UserServiceUpdateUserCounterArgs = map[int16]string{
	1: "req",
}

func (p *UserServiceUpdateUserCounterArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *UserServiceUpdateUserCounterArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceUpdateUserCounterArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceUpdateUserCounterArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewUpdateUserCounterRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *UserServiceUpdateUserCounterArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UpdateUserCounter_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *UserServiceUpdateUserCounterArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *UserServiceUpdateUserCounterArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceUpdateUserCounterArgs(%+v)", *p)
}

func (p *UserServiceUpdateUserCounterArgs) DeepEqual(ano *UserServiceUpdateUserCounterArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *UserServiceUpdateUserCounterArgs) Field1DeepEqual(src *UpdateUserCounterRequest) bool {
...
type UserServiceUpdateUserCounterResult struct {
	Success *UpdateUserCounterResponse `thrift:"success,0,optional" frugal:"0,optional,UpdateUserCounterResponse" json:"success,omitempty"`
}

func NewUserServiceUpdateUserCounterResult() *UserServiceUpdateUserCounterResult {
	return &UserServiceUpdateUserCounterResult{}
}

func (p *UserServiceUpdateUserCounterResult) InitDefault() {
	*p = UserServiceUpdateUserCounterResult{}
}

var UserServiceUpdateUserCounterResult_Success_DEFAULT *UpdateUserCounterResponse

func (p *UserServiceUpdateUserCounterResult) GetSuccess() (v *UpdateUserCounterResponse) {
	if !p.IsSetSuccess() {
		return UserServiceUpdateUserCounterResult_Success_DEFAULT
	}
	return p.Success
}
func (p *UserServiceUpdateUserCounterResult) SetSuccess(x interface{}) {
	p.Success = x.(*UpdateUserCounterResponse)
}

var fieldIDToName_UserServiceUpdateUserCounterResult = map[int16]string{
	0: "success",
}

func (p *UserServiceUpdateUserCounterResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UserServiceUpdateUserCounterResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceUpdateUserCounterResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceUpdateUserCounterResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewUpdateUserCounterResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *UserServiceUpdateUserCounterResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UpdateUserCounter_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *UserServiceUpdateUserCounterResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *UserServiceUpdateUserCounterResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceUpdateUserCounterResult(%+v)", *p)
}

func (p *UserServiceUpdateUserCounterResult) DeepEqual(ano *UserServiceUpdateUserCounterResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *UserServiceUpdateUserCounterResult) Field0DeepEqual(src *UpdateUserCounterResponse) bool {
